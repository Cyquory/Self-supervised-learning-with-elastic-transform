...
def train_auxiliary():
    ...
    transform = transforms.Compose([
        transforms.RandomResizedCrop(args.image_size, scale=crops_scale, interpolation=transforms.InterpolationMode('bicubic')), 
        transforms.ToTensor(),
        transforms.Normalize(imagenet_mean, imagenet_std),
    ])
    dataset = datasets.ImageFolder(root=Path(args.data_path)/'train', transform=transform)
